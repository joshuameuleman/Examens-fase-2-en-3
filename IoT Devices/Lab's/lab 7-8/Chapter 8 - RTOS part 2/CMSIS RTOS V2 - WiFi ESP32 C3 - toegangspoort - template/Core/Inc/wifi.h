	...
	#define HTTP_HOST 						"rubu.be"
	#define HTTPS_HOST 						"...-default-rtdb.europe-west1.firebasedatabase.app"  // Deze database link kan je opzoeken in je Firebase console.
	...
	// API key voor HTTP.
	#define HTTP_APIKEY 		"api123"
	
	// MQTT defines.	
	#define MQTT_SUB_TOPIC 				"vives/..."
	#define MQTT_PUB_TOPIC 				"vives/..."
