...
#define LED_TIMER_TICKED_FLAG 0x00000001					// Timer die aangeeft wanneer de LED mag toggle'n.
#define GATE_MOVING_TIMER_TICKED_FLAG 0x00000002	// Timer die aangeeft dat de poort al lang genoeg in beweging is.
